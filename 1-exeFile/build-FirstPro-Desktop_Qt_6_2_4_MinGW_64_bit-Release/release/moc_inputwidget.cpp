...
#include <memory>
#include "../../../Desktop/testovoe/1-PrimeNumbersVisualisation/widgetElems/inputwidget.h"
...
QT_MOC_LITERAL(12, 15), // "numberSubmitted"
QT_MOC_LITERAL(28, 0), // ""
QT_MOC_LITERAL(29, 5), // "value"
QT_MOC_LITERAL(35, 12) // "processInput"

    },
    "InputWidget\0numberSubmitted\0\0value\0"
    "processInput"
};
...
void InputWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->numberSubmitted((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->processInput(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&InputWidget::numberSubmitted)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void InputWidget::numberSubmitted(int _t1)
{
