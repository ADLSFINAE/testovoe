...
#include <memory>
#include "../../../Desktop/testovoe/4-IntegerandBinaryValidatorVisualisation/FourProg/widgetElems/infowidget.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_InfoWidget_t, stringdata0) + ofs), len 
...
const QMetaObject InfoWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_InfoWidget.offsetsAndSize,
