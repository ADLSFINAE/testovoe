...
#include <memory>
#include "../../../Desktop/testovoe/4-IntegerandBinaryValidatorVisualisation/FourProg/widgetElems/inputwidget.h"
...
QT_MOC_LITERAL(12, 16), // "signalSendNumber"
QT_MOC_LITERAL(29, 0), // ""
QT_MOC_LITERAL(30, 6), // "number"
QT_MOC_LITERAL(37, 13) // "slotGetNumber"

    },
    "InputWidget\0signalSendNumber\0\0number\0"
    "slotGetNumber"
};
...
void InputWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->signalSendNumber((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        ...
        {
            using _t = void (InputWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&InputWidget::signalSendNumber)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<InputWidget, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<int, std::false_type>
...
// SIGNAL 0
void InputWidget::signalSendNumber(int _t1)
{
