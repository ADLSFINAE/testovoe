...
#include <memory>
#include "../../../Desktop/testovoe/2-MySimpleWordVisualisation/SecondProg/widgetElems/tableElems/customtablewidget.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_CustomTableWidget_t, stringdata0) + ofs), len 
...
QT_MOC_LITERAL(18, 13), // "slotToDoTable"
QT_MOC_LITERAL(32, 0), // ""
QT_MOC_LITERAL(33, 13), // "QMap<int,int>"
QT_MOC_LITERAL(47, 5) // "stats"

    },
    "CustomTableWidget\0slotToDoTable\0\0"
    "QMap<int,int>\0stats"
};
...
void CustomTableWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->slotToDoTable((*reinterpret_cast< std::add_pointer_t<QMap<int,int>>>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject CustomTableWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CustomTableWidget.offsetsAndSize,
...
, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<QMap<int,int>, std::false_type>
